...
% argumentBPLabelling([IN, OUT, UND], [IN, OUT, UND]).
argumentBPLabelling([IN, OUT, UND], [BPIN, BPOUT, BPUND]) :-
    hbp(IN, OUT, UND, BPIN, BPOUT, BPUND).

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

hbp(IN, OUT, UND, ResultIN, ResultOUT, ResultUND) :-
   ...
   hbp(NewIN, NewOUT, NewUnd, ResultIN, ResultOUT, ResultUND).

hbp(IN, OUT, UND, IN, OUT, UND).
